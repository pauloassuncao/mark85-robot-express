...
client = MongoClient('mongodb+srv://qa:xperience@cluster0.hdd7xqn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
def insert_user(user):
    ...
    #Implementando a biblioteca de criptografia de senha
